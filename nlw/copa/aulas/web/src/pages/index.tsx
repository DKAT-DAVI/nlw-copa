    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28'>
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          <Image src={usersAvatarExampleImg} alt="Exemplo de avatar"/>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          ...
          <input className='flex-1 px-6 py-4 rounded bg-gray-800 border border-gray-600 text-sm text-gray-300 outline-none'
          type="text" 
          required
      ...
      <Image src={ appPreviewImage } alt="Dois celulares com a prévia da aplicação mobile" quality={100}/>
    </div>
  )
}
